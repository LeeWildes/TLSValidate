...
002F 3 c - r RSA_WITH_AES_128_CBC_SHA_APPROVED
0030 3 c - h DH_DSS_WITH_AES_128_CBC_SHA_APPROVED
0031 3 c - h DH_RSA_WITH_AES_128_CBC_SHA_APPROVED
0032 3 c d d DHE_DSS_WITH_AES_128_CBC_SHA_APPROVED
0033 3 c d r DHE_RSA_WITH_AES_128_CBC_SHA_APPROVED
0034 3 c d n DH_anon_WITH_AES_128_CBC_SHA_APPROVED
0035 3 c - r RSA_WITH_AES_256_CBC_SHA_APPROVED
0036 3 c - h DH_DSS_WITH_AES_256_CBC_SHA_APPROVED
0037 3 c - h DH_RSA_WITH_AES_256_CBC_SHA_APPROVED
0038 3 c d d DHE_DSS_WITH_AES_256_CBC_SHA_APPROVED
0039 3 c d r DHE_RSA_WITH_AES_256_CBC_SHA_APPROVED
003A 3 c d n DH_anon_WITH_AES_256_CBC_SHA_APPROVED
003B 0 - - r RSA_WITH_NULL_SHA256
003C 3 c - r RSA_WITH_AES_128_CBC_SHA256_APPROVED
003D 3 c - r RSA_WITH_AES_256_CBC_SHA256_APPROVED
003E 3 c - h DH_DSS_WITH_AES_128_CBC_SHA256_APPROVED
003F 3 c - h DH_RSA_WITH_AES_128_CBC_SHA256_APPROVED
0040 3 c d d DHE_DSS_WITH_AES_128_CBC_SHA256_APPROVED
...
0067 3 c d r DHE_RSA_WITH_AES_128_CBC_SHA256_APPROVED
0068 3 c - h DH_DSS_WITH_AES_256_CBC_SHA256_APPROVED
0069 3 c - h DH_RSA_WITH_AES_256_CBC_SHA256_APPROVED
006A 3 c d d DHE_DSS_WITH_AES_256_CBC_SHA256_APPROVED
006B 3 c d r DHE_RSA_WITH_AES_256_CBC_SHA256_APPROVED
006C 3 c d n DH_anon_WITH_AES_128_CBC_SHA256_APPROVED
006D 3 c d n DH_anon_WITH_AES_256_CBC_SHA256_APPROVED
...
009C 3 - - r RSA_WITH_AES_128_GCM_SHA256_APPROVED
009D 3 - - r RSA_WITH_AES_256_GCM_SHA384_APPROVED
009E 3 - d r DHE_RSA_WITH_AES_128_GCM_SHA256_APPROVED
009F 3 - d r DHE_RSA_WITH_AES_256_GCM_SHA384_APPROVED
00A0 3 - - h DH_RSA_WITH_AES_128_GCM_SHA256_APPROVED
00A1 3 - - h DH_RSA_WITH_AES_256_GCM_SHA384_APPROVED
00A2 3 - d d DHE_DSS_WITH_AES_128_GCM_SHA256_APPROVED
00A3 3 - d d DHE_DSS_WITH_AES_256_GCM_SHA384_APPROVED
00A4 3 - - h DH_DSS_WITH_AES_128_GCM_SHA256_APPROVED
00A5 3 - - h DH_DSS_WITH_AES_256_GCM_SHA384_APPROVED
00A6 3 - d n DH_anon_WITH_AES_128_GCM_SHA256_APPROVED
00A7 3 - d n DH_anon_WITH_AES_256_GCM_SHA384_APPROVED
...
C004 3 c - e ECDH_ECDSA_WITH_AES_128_CBC_SHA_APPROVED
C005 3 c - e ECDH_ECDSA_WITH_AES_256_CBC_SHA_APPROVED
...
C009 3 c e e ECDHE_ECDSA_WITH_AES_128_CBC_SHA_APPROVED
C00A 3 c e e ECDHE_ECDSA_WITH_AES_256_CBC_SHA_APPROVED
C00B 0 - - e ECDH_RSA_WITH_NULL_SHA
C00C 3 r - e ECDH_RSA_WITH_RC4_128_SHA
C00D 3 c - e ECDH_RSA_WITH_3DES_EDE_CBC_SHA
C00E 3 c - e ECDH_RSA_WITH_AES_128_CBC_SHA_APPROVED
C00F 3 c - e ECDH_RSA_WITH_AES_256_CBC_SHA_APPROVED
C010 0 - e r ECDHE_RSA_WITH_NULL_SHA
C011 3 r e r ECDHE_RSA_WITH_RC4_128_SHA
C012 3 c e r ECDHE_RSA_WITH_3DES_EDE_CBC_SHA
C013 3 c e r ECDHE_RSA_WITH_AES_128_CBC_SHA_APPROVED
C014 3 c e r ECDHE_RSA_WITH_AES_256_CBC_SHA_APPROVED
...
C023 3 c e e ECDHE_ECDSA_WITH_AES_128_CBC_SHA256_APPROVED
C024 3 c e e ECDHE_ECDSA_WITH_AES_256_CBC_SHA384_APPROVED
C025 3 c - e ECDH_ECDSA_WITH_AES_128_CBC_SHA256_APPROVED
C026 3 c - e ECDH_ECDSA_WITH_AES_256_CBC_SHA384_APPROVED
C027 3 c e r ECDHE_RSA_WITH_AES_128_CBC_SHA256_APPROVED
C028 3 c e r ECDHE_RSA_WITH_AES_256_CBC_SHA384_APPROVED
C029 3 c - e ECDH_RSA_WITH_AES_128_CBC_SHA256_APPROVED
C02A 3 c - e ECDH_RSA_WITH_AES_256_CBC_SHA384_APPROVED
C02B 3 - e e ECDHE_ECDSA_WITH_AES_128_GCM_SHA256_APPROVED
C02C 3 - e e ECDHE_ECDSA_WITH_AES_256_GCM_SHA384_APPROVED
C02D 3 - - e ECDH_ECDSA_WITH_AES_128_GCM_SHA256_APPROVED
C02E 3 - - e ECDH_ECDSA_WITH_AES_256_GCM_SHA384_APPROVED
C02F 3 - e r ECDHE_RSA_WITH_AES_128_GCM_SHA256_APPROVED
C030 3 - e r ECDHE_RSA_WITH_AES_256_GCM_SHA384_APPROVED
C031 3 - - e ECDH_RSA_WITH_AES_128_GCM_SHA256_APPROVED
C032 3 - - e ECDH_RSA_WITH_AES_256_GCM_SHA384_APPROVED
...
C072 3 c e e ECDHE_ECDSA_WITH_CAMELLIA_128_CBC_SHA256_APPROVED
C073 3 c e e ECDHE_ECDSA_WITH_CAMELLIA_256_CBC_SHA384_APPROVED
C074 3 c - e ECDH_ECDSA_WITH_CAMELLIA_128_CBC_SHA256_APPROVED
C075 3 c - e ECDH_ECDSA_WITH_CAMELLIA_256_CBC_SHA384_APPROVED
C076 3 c e r ECDHE_RSA_WITH_CAMELLIA_128_CBC_SHA256_APPROVED
C077 3 c e r ECDHE_RSA_WITH_CAMELLIA_256_CBC_SHA384_APPROVED
C078 3 c - e ECDH_RSA_WITH_CAMELLIA_128_CBC_SHA256_APPROVED
C079 3 c - e ECDH_RSA_WITH_CAMELLIA_256_CBC_SHA384_APPROVED
